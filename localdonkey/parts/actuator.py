...
class PWMThrottle:
    ...
    def run_threaded(self, throttle):
        if throttle > 0:
            ...
            # The traxx car uses a different puls for reverse 395 
            # the zero puls is 370 but I does not work a reverse
            # the 25 is correction for the zero puls
            self.pulse = dk.utils.map_range(throttle, self.MIN_THROTTLE, 0,
                                            self.min_pulse, self.zero_pulse + 25)
